...
public interface BinanceApiRestClient {
    ...
    void marginTransfer(MarginTransferRequestModel marginTransfer);

    void marginLoan(MarginBorrowRequestModel marginTransfer);

    void marginRepay(MarginBorrowRequestModel marginTransfer);
